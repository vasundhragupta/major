...
<?php
 if (isset($_POST["choice"])) {
	...
	echo "<center><div style= 'background: #cccccc; width:400px; margin-top: 7%;  box-shadow: 10px 10px 5px #888888;  border-radius: 25px;'><form id='bform' name='bform' onSubmit='return false;'>";
	echo "<br><br>Name : <input type='text' id='bname' name='bname'/><br><br>";
	...
	echo "<br><button id='but1' style='background:black; color: white; padding: 10px;' onclick='addbat();'>Add Batch</button><br><br>";
