...
if (isset ($_POST['sid'])) {
	...
	echo "<div style='background: #cccccc; width:1226px'><table id='param-table' align='center' style=' border: 1px solid black;'><tr style=' border: 1px solid black; padding: 15px'><td style=' border: 1px solid black; padding: 15px;'>Subject Code</td><td style=' border: 1px solid black;  padding: 15px;'>Type (lab, tut or lecture)</td><td style='  padding: 15px; border: 1px solid black;'>Subject Name</td><td style='  padding: 15px; border: 1px solid black;'>Year</td><td style='  padding: 15px; border: 1px solid black;'>Branch</td><td style='  padding: 15px; border: 1px solid black;'>Hours</td> <td style='  padding: 15px; border: 1px solid black;'>Edit Subject</td><tr>";
	while ($row_users = mysqli_fetch_array($results)) {
		echo "<form onSubmit='return false;' method='POST' style='float:left;'><tr style=' border: 1px solid black;  padding: 15px;'><td style=' border: 1px solid black;  padding: 15px;'>".$row_users['Scode']."</td><td style=' border: 1px solid black;  padding: 15px;'>"."<input name='stype' type='text'  maxlength='50' value='".$row_users['Type']."'>"."</td><td style=' border: 1px solid black;  padding: 15px;'>"."<input name='sname' type='text'  maxlength='50' value='".$row_users['Sname']."'>"."</td><td style=' border: 1px solid black;  padding: 15px;'>"."<input name='year' type='text'  maxlength='20' value='".$row_users['Year']."'>"."</td><td style=' border: 1px solid black;  padding: 15px;'>"."<input name='branch' type='text'  maxlength='20' value='".$row_users['Branch']."'>"."</td><td style=' border: 1px solid black;  padding: 15px;'>"."<input name='hour' type='text'  maxlength='20' value='".$row_users['Hours']."'>"."</td><td style=' border: 1px solid black;  padding: 15px;'>"."<button style= 'background: black; color: white; padding: 10px' onclick='editParam(\"" . $row_users['Scode'] . "\", this)'>Edit</button>"."</td></form></tr>";
	}
	echo "</table></div>";
	}
...
<body background = "bg.png"> 
	...
	<button style= 'background: black; color: white; padding: 9px;' onclick="filter()">Filter</button>
</form>
