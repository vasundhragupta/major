...
if (isset ($_POST['rid'])) {
	...
	echo "<div style='background: #cccccc; width:700px'><table id='param-table' align='center' style=' border: 1px solid black;'><tr style=' border: 1px solid black; padding: 15px'><td style=' border: 1px solid black; padding: 15px;'>Room Name</td><td style=' border: 1px solid black;  padding: 15px;'>Type</td><td style='  padding: 15px; border: 1px solid black;'>Capacity</td><td style='  padding: 15px; border: 1px solid black;'>Location</td> <td style='  padding: 15px; border: 1px solid black;'>Edit Room</td><tr>";
	while ($row_users = mysqli_fetch_array($results)) {
		echo "<form onSubmit='return false;' method='POST' style='float:left;'><tr style=' border: 1px solid black;  padding: 15px;'><td style=' border: 1px solid black;  padding: 15px;'>".$row_users['Name']."</td><td style=' border: 1px solid black;  padding: 15px;'>"."<input name='rtype' type='text'  maxlength='50' value='".$row_users['Type']."'>"."</td><td style=' border: 1px solid black;  padding: 15px;'>"."<input name='cap' type='text'  maxlength='50' value='".$row_users['Capacity']."'>"."</td><td style=' border: 1px solid black;  padding: 15px;'>".$row_users['Location']."</td><td style=' border: 1px solid black;  padding: 15px;'>"."<button style= 'background: black; color: white; padding: 10px' onclick='editParam(\"" . $row_users['Name'] . "\", this)'>Edit</button>"."</td></form></tr>";
	}
	echo "</table></div>";
	}
	//echo "Success!";
