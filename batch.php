...
if (isset ($_POST['sid'])) {
	...
	echo "<div style='background: #cccccc; width:700px'><table id='param-table' align='center' style=' border: 1px solid black;'><tr style=' border: 1px solid black; padding: 15px'><td style=' border: 1px solid black; padding: 15px;'>Batch Name</td><td style=' border: 1px solid black;  padding: 15px;'>Type</td><td style='  padding: 15px; border: 1px solid black;'>Subjects</td><td style='  padding: 15px; border: 1px solid black;'>Year</td> <td style='  padding: 15px; border: 1px solid black;'>Edit Batch</td><tr>";
	while ($row_users = mysqli_fetch_array($results)) {
		echo "<form onSubmit='return false;' method='POST' style='float:left;'><tr style=' border: 1px solid black;  padding: 15px;'><td style=' border: 1px solid black;  padding: 15px;'>".$row_users['Name']."</td><td style=' border: 1px solid black;  padding: 15px;'>"."<input name='btype' type='text'  maxlength='50' value='".$row_users['Type']."'>"."</td><td style=' border: 1px solid black;  padding: 15px;'>"."<input name='subject' type='text'  maxlength='50' value='".$row_users['Subject']."'>"."</td><td style=' border: 1px solid black;  padding: 15px;'>".$row_users['Year']."</td><td style=' border: 1px solid black;  padding: 15px;'>"."<button style= 'background: black; color: white; padding: 10px' onclick='editParam(\"" . $row_users['Name'] . "\",\"" . $row_users['Year'] . "\", this)'>Edit</button>"."</td></form></tr>";
	}
	echo "</table></div>";
	}
	//echo "Success!";
