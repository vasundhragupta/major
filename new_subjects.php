...
<body background = "bg.png">
	...
	<center>
	<div style='background: #cccccc; width:400px; margin-top: 10%;  box-shadow: 10px 10px 5px #888888;  border-radius: 25px;'>
	<br><br>
	<form onSubmit="return false;" name="sform" id="sform">
    ...
    <h4><span id="status" style="color: red"></span></h4><br>
	</div>
	</center>
</body>
</html>